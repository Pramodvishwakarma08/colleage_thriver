...
/// current visitCollegesModelObj
class VisitCollegesController extends GetxController {
  ...
  Future<void> updateProfileImage(CroppedFile file) async {
     ...
     var formData = FormData.fromMap({'clg_campus': [await MultipartFile.fromFile(file.path, ),],});
     final response = await  ApiClient().postRequest(endPoint:AppUrls.college_3_of_05 , body: formData);
