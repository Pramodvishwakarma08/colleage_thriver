...
// // //
// // //     final favrateCollegeListModel = favrateCollegeListModelFromJson(jsonString);
// //
// // import 'dart:convert';
// //
// // import 'package:colleage_thriver/presentation/search/models/CollegeDetailListModel.dart';
// //
// // FavrateCollegeListModel favrateCollegeListModelFromJson(String str) => FavrateCollegeListModel.fromJson(json.decode(str));
// //
// // String favrateCollegeListModelToJson(FavrateCollegeListModel data) => json.encode(data.toJson());
// //
// // class FavrateCollegeListModel {
// //   bool? success;
// //   int? status;
// //   String? message;
// //
// //   List<Message>? collegeDetails;
// //
// //   FavrateCollegeListModel({
// //     this.success,
// //     this.status,
// //     this.message,
// //     this.collegeDetails,
// //   });
// //
// //   factory FavrateCollegeListModel.fromJson(Map<String, dynamic> json) => FavrateCollegeListModel(
// //     success: json["success"],
// //     status: json["status"],
// //     message: json["message"],
// //     collegeDetails: json["collegeDetails"] == null ? [] : List<Message>.from(json["collegeDetails"]!.map((x) => Message.fromJson(x))),
// //   );
// //
...
// //     "status": status,
// //     "message": message,
// //     "collegeDetails": collegeDetails == null ? [] : List<dynamic>.from(collegeDetails!.map((x) => x.toJson())),
// //   };
// // }
// //
// //
