...
///
/// This class manages the state of the FileYourFafsaPage, including the
/// current fileYourFafsaModelObj
class FileYourFafsaController extends GetxController {
 ...
 Future<void> updateProfileImage(CroppedFile file) async {
  ...
  var formData = FormData.fromMap({'fafsa_file': [await MultipartFile.fromFile(file.path, ),],});
  final response = await  ApiClient().postRequest(endPoint:AppUrls.scholar_05 , body: formData);
