...
/// A controller class for the ApplyToCollegeBoardPage.
///
/// This class manages the state of the ApplyToCollegeBoardPage, including the
/// current applyToCollegeBoardModelObj
class ApplyToCollegeBoardController extends GetxController {
  ...
  Future<void> updateProfileImage(CroppedFile file) async {
    ...
    var formData = FormData.fromMap({'college_board_file': [await MultipartFile.fromFile(file.path, ),],});
    final response = await  ApiClient().postRequest(endPoint:AppUrls.scholar_04 , body: formData);
