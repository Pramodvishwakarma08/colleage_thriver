...
import 'package:colleage_thriver/widgets/custom_image_view.dart';
            ...
            child: Form(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: 11.h), child: Text("lbl_password".tr, style: theme.textTheme.bodyMedium)),
                    SizedBox(height: 9.v),
